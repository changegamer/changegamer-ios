...
extension UIColor{
     ...
     */
    public convenience init(rgba_throws rgba: ColorName) throws {
        guard rgba.rawValue.hasPrefix("#") else {
            throw UIColorInputError.missingHashMarkAsPrefix
        }
        
        let hexString: String = rgba.rawValue.substring(from: rgba.rawValue.characters.index(rgba.rawValue.startIndex, offsetBy: 1))
    ...
    /**
     ...
     - parameter rgba: String value.
     */
    public convenience init(_ rgba: ColorName, defaultColor: UIColor = UIColor.clear) {
